										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/visit_toUpdateVisit?vid=${visit.vid}">修改</a>
														<a href="${pageContext.request.contextPath }/visit_deleteVisit?vid=${visit.vid}" >删除</a>
													</TD>
												</TR>
												</c:forEach>
